...
public class MainActivity extends AppCompatActivity {
    ...
    private View.OnClickListener listener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            if (minIn.getText() != null && maxIn.getText() != null) {

                // считывание введённых параметров
                minMass = Float.parseFloat(minIn.getText().toString());
                maxMass = Float.parseFloat(maxIn.getText().toString());
                ...
                stream.filter(s -> s.getMass() >= minMass && s.getMass() <= maxMass).forEach(a -> output.append(a.getSymbol() + " " + a.getMass() + "\n"));
